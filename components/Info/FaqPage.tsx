...
const FAQ_DATA: Record<Language, FaqItem[]> = {
    uk: [
        ...
        },
        {
            ...
            a: 'Тест базується на науково валідованих опитувальниках (зокрема VVIQ — Vividness of Visual Imagery Questionnaire). Он дає хорошу оцінку вашого суб\'єктивного досвіду, але не є клінічним інструментом. Результати слід сприймати як відправну точку для саморефлексії.',
        },
        {
        ...
        },
        {
            ...
            a: 'Реєстрація нових користувачів не надає безкоштовних кредитів. Генерація аналізу профілю коштує: Експрес-діагностика — 100 кредитів, Повна діагностика — 250 кредитів.',
        },
        {
    ...
    en: [
        ...
        },
        {
            ...
            a: 'New user registration does not include free credits. Generating a profile analysis costs: Express Diagnostics — 100 credits, Full Profile — 250 credits.',
        },
        {
    ...
    ru: [
        ...
        },
        {
            ...
            a: 'После авторизации через Google ваши ответы и результаты сохраняются на нашем сервере. Это позволяет вам вернуться к ним в любой момент. Мы не передаем их третьим лицам. Подробнее — в Политике конфиденциальности.',
        },
        {
        ...
        },
        {
            ...
            a: 'Регистрация новых пользователей не предоставляет бесплатных кредитов. Генерация анализа профиля стоит: Экспресс-диагностика — 100 кредитов, Полная диагностика — 250 кредитов.',
        },
        {
